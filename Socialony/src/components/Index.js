...
const Index = () => {
  ...
  const SubmitNewPost = (e) => {
    ...
    if (newPost === "") {
      message.error({
        content: "Empty Post Can Not Be Shared!",
        key,
        duration: 2,
      });
    } else {
        ...
        return (
          <Grid item container justifyContent="center" xs={12}>
            <Empty
              ...
              description={
                <span>
                  Looks Like You Dont Follow Anyone. You Can Search or Follow
                  Users on Search Bar.
                </span>
              }
            />
        ...
        <Grid item container xs={10} lg={6} className={classes.root}>
          ...
          <Grid item container xs={12} className={classes.newpostdiv}>
            {isLogged ? (
              <React.Fragment>
                ...
                >
                  <Button color="facebook" onClick={SubmitNewPost}>
                    Send
                  </Button>
                </Grid>
              </React.Fragment>
          ...
          <Grid item container xs={12} className={classes.posts}>
            <Grid
              ...
              style={{
                display: isLoading ? (isLogged ? "flex" : "none") : "none",
              }}
            >
              <CircularProgress />
            </Grid>
