          ...
          return (
            <Grid
              ...
              className={`${classes.each} ${
                activeIndex === index ? "activeMessageUser" : ""
              }`}
              onClick={() => {
        ...
        return (
          <Grid container item justifyContent="center">
            <Empty
              ...
              description={<span>No Message</span>}
            />
          </Grid>
        );
      }
        ...
        return (
          ...
          >
            <div
              style={{
                borderTopLeftRadius:
                  message.sender === user.userId ? "15px" : "0",
                borderTopRightRadius:
                  message.sender === user.userId ? "0" : "15px",
              }}
            >
      ...
      >
        <Grid item container xs={12} lg={4} className={classes.left} ref={left}>
          <Grid container item className={classes.header}>
            ...
            <Grid>
              ...
              >{`${user.credentials?.name} ${user.credentials?.surname}`}</Typography>
        ...
        {messages && (
          ...
          >
            ...
            >
              {width < 450 && (
                <ArrowBackIcon className={classes.backicon} onClick={back} />
              )}
              <Typography variant="h5">
                {messages[activeIndex]?.name}
              </Typography>
              <IconButton
                aria-label="settings"
                className={classes.headersettings}
              >
                <Dropdown
                  overlay={
                    <Menu>
                      <Menu.Item>
                        <Link
                          to={`/user/${messages[activeIndex]?.id}`}
            ...
            <Grid item container className={classes.chatmessages}>
              ...
              <Grid
                ...
                style={{ maxHeight: isOpen ? "60vh" : "72vh" }}
                ref={chatBoxRef}
              >
