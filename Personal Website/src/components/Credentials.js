    ...
    return (
        <Container style={{ padding: width < 450 ? '30px' : '20px 100px' }} id="About">
            ...
            <EachPart>
                ...
                <Education container>
                    <Grid container item xs={12} className={width < 450 ? 'wow bounceInUp' : 'wow bounceInLeft'} data-wow-duration="1s" data-wow-delay="0.5s" style={{ marginTop: '70px' }}>
                        <Grid item container xs={12} md={4} alignItems="center" justify="center">
                            <Description style={{ textAlign: width < 450 ? 'center' : 'right', marginBottom: width < 450 ? '25px' : '0' }}>University</Description>
                        </Grid>
                    ...
                    <Grid container item xs={12} className={width < 450 ? 'wow bounceInUp' : 'wow bounceInLeft'} data-wow-duration="1s" data-wow-delay="0.5s" style={{ marginTop: '80px' }}>
                        <Grid item container xs={12} md={4} alignItems="center" justify="center">
                            <Description style={{ textAlign: width < 450 ? 'center' : 'right', marginBottom: width < 450 ? '25px' : '0' }}>High School</Description>
                        </Grid>
                        <Grid item container xs={12} md={8} direction="column" justify="center">
            ...
            <EachPart>
                <Divider horizontal className={width < 450 ? 'wow bounceInUp' : 'wow bounceInRight'} data-wow-duration="1s" data-wow-delay="0.5s">
                    <Hdr as='h3'>
                        <Icon name='briefcase' />
                        Experiences
                    </Hdr>
                ...
                <Education>
                    <Grid container className={width < 450 ? 'wow bounceInUp' : 'wow bounceInLeft'} data-wow-duration="1s" data-wow-delay="0.5s" style={{ marginTop: '70px' }}>
                        <Grid item container xs={12} md={4} alignItems="center" justify="center">
                            <Description style={{ textAlign: width < 450 ? 'center' : 'right', marginBottom: width < 450 ? '25px' : '0' }}>Orion Innovation</Description>
                        </Grid>
                        <Grid item container xs={12} md={8} direction="column" justify="center">
                            <SubTitle>Full Stack Developer</SubTitle>
                            <Date>12.2021 - Now</Date>
                        </Grid>
                    </Grid>
                    <Grid container className={width < 450 ? 'wow bounceInUp' : 'wow bounceInLeft'} data-wow-duration="1s" data-wow-delay="0.5s" style={{ marginTop: '70px' }}>
                        <Grid item container xs={12} md={4} alignItems="center" justify="center">
                    ...
                    <Grid container className={width < 450 ? 'wow bounceInUp' : 'wow bounceInLeft'} data-wow-duration="1s" data-wow-delay="0.5s" style={{ marginTop: '80px' }}>
                        <Grid item container xs={12} md={4} alignItems="center" justify="center" >
                            <Description style={{ textAlign: width < 450 ? 'center' : 'right', marginBottom: width < 450 ? '25px' : '0' }}>Exhibin</Description>
                        </Grid>
                        <Grid item container xs={12} md={8} direction="column" justify="center">
                            <SubTitle>Front End Developer</SubTitle>
                    ...
                    <Grid container className={width < 450 ? 'wow bounceInUp' : 'wow bounceInLeft'} data-wow-duration="1s" data-wow-delay="0.5s" style={{ marginTop: '80px' }}>
                        <Grid item container xs={12} md={4} alignItems="center" justify="center">
                            <Description style={{ textAlign: width < 450 ? 'center' : 'right', marginBottom: width < 450 ? '25px' : '0' }}>IBM</Description>
                        </Grid>
                        <Grid item container xs={12} md={8} direction="column" justify="center">
