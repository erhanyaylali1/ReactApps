...
const Contact = () => {
    ...
    return ( 
        ...
        >
            <Grid container item xs={10} md={6} justify="center" className="wow bounceInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <Form className={classes.form}>
                    <Grid className="wow bounceInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                        <Grid container justify="center" alignItems="center" className={classes.contact}>
                            ...
                            <Typography className={classes.title} align="center" style={{ fontSize: width < 450 ? '25px':'35px'}}>
                                Contact Me
                            </Typography>
                        </Grid>
                    </Grid>
                    <Form.Input fluid label='Name Surname' placeholder='Name' 
                        value={name}
                        required
                        type="text"
                    ...
                    />
                    <Form.TextArea fluid label='Content' placeholder='Content' 
                        value={content}
                        required
            ...
            <Grid container item xs={12} justify="center" className={classes.infos}>
                <Grid item container xs={12} justify="center" className="wow bounceInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                    <Typography style={{ fontSize: width < 450 ? '12px':'16px' }} className={classes.socialInfo} variant="overline">
            ...
            <Grid container item xs={12} justify="center" className={classes.socials}>
                <Grid container item xs={6} lg={6} className="wow bounceInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
